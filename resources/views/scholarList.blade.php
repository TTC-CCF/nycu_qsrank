...
<body>
    ...
    <div class="list-container">
        ...
        <div class="btn-group" role="group" id="chooseBtn">
            ...
            <button id="dup_btn" class="btn btn-outline-dark" onclick="showDup()"><span class="duplicate-color-block"></span>檢查重複資料</button>
        </div>
            ...
            <table id='table' class="table table-striped  table-fix-column">
                ...
                <tbody>
                    ...
                    <tr @if ($row["dupUnits"]) style="background-color:#ffbf00;" @endif>
                        ...
                        <td @if((session('id') === $unit && $permit === "write") || $admin) class="editable" @endif row="Broad Subject Area">
